...
extern int FindReplaceTextures(const char* pFind, const char* pReplace, bool bSelected, bool bForce, bool bReScale, bool bFindOnlyNoReplace, bool bInhibitCameraUpdate = false, bool bCalledDuringLoopAndNotFirstTime = false);
...
// stuff to help with MFC, since I can never remember which way round the bool is for CDialog::UpdateData()...
//
#define DATA_TO_DIALOG FALSE
#define DIALOG_TO_DATA TRUE

#define sEF1_BEHAVED_PATH "k:\\util\\runbehavedlocal.bat"	//"q:\\bin_nt\\BehavEd.exe"
#define sCHC_BEHAVED_PATH "k:\\util\\runbehavedlocal.bat"	//"w:\\bin\\BehavEd.exe"
