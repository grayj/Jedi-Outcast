...
#include "mathlib.h"
#include "polylib.h"
#include "qfiles.h"	//for min_world_coord
				...
				vec_t epsilon, winding_t **front, winding_t **back)
{
	...
	{			
		Error ("ClipWindingEpsilon:  %d > MAX_POINTS_ON_WINDING (%d)\nSample points: (%5.2f %5.2f %5.2f) (%5.2f %5.2f %5.2f) (%5.2f %5.2f %5.2f)",
			in->numpoints,MAX_POINTS_ON_WINDING,
			in->p[0][0],in->p[0][1],in->p[0][2],
			in->p[10][0],in->p[10][1],in->p[10][2],
			in->p[20][0],in->p[20][1],in->p[20][2]);
	}
